...
const Rating = ({ rating, totalReviews, isMobile}) => {

    return (
        <div className=" row">
            <div className={`col-lg-6 ${!isMobile?'text-right':'text-center'}`}>
        ...
        <div className={` col-lg-6 pt-1 ${!isMobile?'text-left':'text-center'}`}>
            <h4>
